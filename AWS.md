...
<li>if you want to restore the delete marker object file, just delete the delete mark file particular version, then the second latest file will back.</li>
</ul>
