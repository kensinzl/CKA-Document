...
<ul>
<li>Gracefully shutdown the instance, if the request has been already traficed into Instance A, then will continue to execute until finish or time-out, then Instance A will be moved from ELB.</li>
